...
<link href="${contextPath }/static/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<form class="form form-horizontal" action="${contextPath }/LoginController/login.do" method="post" onsubmit="return login();">
				<div class="row cl">
